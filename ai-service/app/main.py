...
from app.routes import prediction_routes, generation_routes, ocr_routes, classify_routes, analysis_routes, analytics_routes
...
app.include_router(analysis_routes.router,   prefix="/ai/analyze",    tags=["Analysis"])
app.include_router(analytics_routes.router,  prefix="/ai/analytics",  tags=["Analytics"])
